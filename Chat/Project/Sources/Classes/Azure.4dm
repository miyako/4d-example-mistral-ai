...
Class constructor($model : Text; $resultObjectName : Text; $continueObjectName : Text; $promptObjectName : Text)
	...
	$keyFile:=Folder:C1567(Folder:C1567("/PACKAGE/").platformPath; fk platform path:K87:2).parent.file("Azure.token")
	
	Super:C1705("https://4d.openai.azure.com/openai/v1"; $keyFile; \
