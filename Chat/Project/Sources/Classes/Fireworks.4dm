...
Class constructor($model : Text; $resultObjectName : Text; $continueObjectName : Text; $promptObjectName : Text)
	...
	$keyFile:=Folder:C1567(Folder:C1567("/PACKAGE/").platformPath; fk platform path:K87:2).parent.file("Fireworks.token")
	
	Super:C1705("https://api.fireworks.ai/inference/v1"; $keyFile; \
