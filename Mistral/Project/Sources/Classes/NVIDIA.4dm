...
Class constructor($model : Text; $resultObjectName : Text; $continueObjectName : Text; $promptObjectName : Text)
	...
	$keyFile:=Folder:C1567(Folder:C1567("/PACKAGE/").platformPath; fk platform path:K87:2).parent.file("NVIDIA.token")
	
	Super:C1705("https://integrate.api.nvidia.com/v1"; $keyFile; \
